...
Call = function () {
  ...
  function Call(name, params) {_classCallCheck(this, Call);
  ...
  }_createClass(Call, null, [{ key: "parse", value: function parse(
    ...
    call, opts) {
      return new (Function.prototype.bind.apply(Call, [null].concat(_toConsumableArray(_ParamParser2.default.parse(call, opts)))))();
