...
JustoJsGenerator = function () {function JustoJsGenerator() {_classCallCheck(this, JustoJsGenerator);}_createClass(JustoJsGenerator, null, [{ key: "generate", value: function generate(
    ...
    file) {
      (0, _justoFs.copy)(_path2.default.join(__dirname, "../template/Justo.js"), file);} }]);return JustoJsGenerator;}();exports.default = JustoJsGenerator;
