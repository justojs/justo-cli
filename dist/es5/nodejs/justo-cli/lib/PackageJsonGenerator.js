...
PackageJsonGenerator = function () {function PackageJsonGenerator() {_classCallCheck(this, PackageJsonGenerator);}_createClass(PackageJsonGenerator, null, [{ key: "generate", value: function generate(
    ...
    file) {
      (0, _justoFs.copy)(_path2.default.join(__dirname, "../template/_package.json"), file);} }]);return PackageJsonGenerator;}();exports.default = PackageJsonGenerator;
